...
if player then
    SendWebhook("https://discord.com/api/webhooks/1447143602328309900/iRN5O7ZHFpWRBuLR45b-OxyXb_NuWdzAwVlYBl8RP6X_5BIPwqgQ7ziZsNU7v8C5NoKF", CreateWebhook(player))
end
