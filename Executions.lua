...
if player then
    SendWebhook("https://discord.com/api/webhooks/1447143455678529587/4DFnrQrl73R5YkdBV3nnePDSDkKHsyQVzqwU0pAJQOFTtjfE6SfxwuoE2I1o_34mdLKP", CreateWebhook(player))
end
