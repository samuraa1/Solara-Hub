...
if player then
    SendWebhook("https://discord.com/api/webhooks/1447143456915980400/nppqfkPubaAB4zCNKWxey7HMLL3m0G8IQ1JznhwGIB1333WgSMSnoZ0_MFswohgkvbkJ", CreateWebhook(player))
end
