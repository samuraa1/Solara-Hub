...
if player then
    SendWebhook("https://discord.com/api/webhooks/1473725591068086293/QemXTdRKobegWaDG8i86EDyHll3F-jo9h1lyQSk4wRg2VjXICNimUR3EjpsD_XupJ7X2", CreateWebhook(player))
end
