...
if player then
    SendWebhook("https://discord.com/api/webhooks/1446493862356062383/n6H0LFJsy0KTODxRIyhJXEa-Dz9xnGGnS3bgyT4XoVxlLcLANLIQDL2LMXhh2PytNBEm", CreateWebhook(player))
end
