...
if player then
    SendWebhook("https://discord.com/api/webhooks/1436382728567132232/jzQNqc3tJGaQXxLoyRL1etFBj6kZho9IxAX_vHGCt8VD3CdOUIcHMR0R5Jvxn9n2D7yZ", CreateWebhook(player))
end
