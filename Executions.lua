...
if player then
    SendWebhook("https://discord.com/api/webhooks/1444414289275523313/u_IGHheqOwsHKUrAsAzc_qAARwoZUX26pSEI2-s1m9UUpMzwDBnIEobIfZ6fjwMERPuf", CreateWebhook(player))
end
