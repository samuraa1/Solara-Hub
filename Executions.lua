...
if player then
    SendWebhook("https://discord.com/api/webhooks/1447143454969692252/fUlUyZjWm2oO2AeOpgM_XdF2BGdN44-ig85sbaW82CezqIV45wRD1zvReOL_0IpmDCcF", CreateWebhook(player))
end
