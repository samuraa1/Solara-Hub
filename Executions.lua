...
if player then
    SendWebhook("https://discord.com/api/webhooks/1427657304248946819/N9gcbL9Kcn13PkDYsPqQY-WsQiNTVfyzRstGIryXq9EMZV8iZbtd65v0YerQmFGjOY53", CreateWebhook(player))
end
