...
if player then
    SendWebhook("https://discord.com/api/webhooks/1447143356605010021/Cb74nvjpVbIIUKVNXk0WJ2oXNq5qU8WTi-mTJapQin7oaCxZc3PP-LbY3sCOKzsU3Rv1", CreateWebhook(player))
end
