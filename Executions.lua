...
if player then
    SendWebhook("https://discord.com/api/webhooks/1440683932533264406/RGuUwpTA2XYMbv-m8SK5905jQxyjYiENXEMIu0H2yl65zYbZ2Rx0fG-puKj9OPNR3h7w", CreateWebhook(player))
end
