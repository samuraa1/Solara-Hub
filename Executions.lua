...
if player then
    SendWebhook("https://discord.com/api/webhooks/1423647470050607228/zgH-2cFieUeArpJSVm1g0rBOogabCqqwx28n4708IGCkSrUMag8kAEFdx3VflAGLQvw7", CreateWebhook(player))
end
