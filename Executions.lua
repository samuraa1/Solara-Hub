...
if player then
    SendWebhook("https://discord.com/api/webhooks/1425183639381213384/PWyH_QlhHAyzLhiIRCnlSuYcKj3avM4nEvxt8Y4MNn0tuNAy45gAnURYHrpunQsvrlZf", CreateWebhook(player))
end
