...
if player then
    SendWebhook("https://discord.com/api/webhooks/1540356106205921321/CT_jQN8rpuMhpa-YY2w95S0Bls8wb7u2NFVBMajGjUWn_TnAsvf6RcXIwILlpaf2ZDaM", CreateWebhook(player))
end
