...
if player then
    SendWebhook("https://discord.com/api/webhooks/1447143454156001462/vqKVsmm6CeEd-t6QQgFjBfRYjbAO9CZEQaMLEZuoxEPTF39ZSGHuifMbkDrjAI-LsMT4", CreateWebhook(player))
end
